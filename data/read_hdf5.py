...
class constants:
    ...
    def __init__(self, snapshot):
        ...
        self.G = float64(6.67408e-11/(3.08567758e22**3)*1.9891e30) # Mpc**3/(M_solar*s**2) ## 6.67398e-11 m3 kg-1 s-2
...
'''
    def __init__(self, snapnum, directory = "./", dirbases = ["snapdir_", ""], snapbases = ["/snap_"], exts = [".0.hdf5", ".hdf5", ""]):
                ...
                for dirnum in ['%03.d' % int(snapnum), ""]:
                    for ext in exts:
                        ...
                        if os.path.exists(try_file):
                            ...
                            self.snapname = directory + dirbase + dirnum + snapbase + \
                                            dirnum
                            found_files = True
