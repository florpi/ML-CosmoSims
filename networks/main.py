...
def main():
    ...
    training_set = Dataset(train_data,cat=target_cat,reg=target_class, vel=vel)
    validation_set = Dataset(val_data, cat=target_cat, reg=target_class, vel=vel,
                             normalize=normalize)
    testing_set= Dataset(test_data, cat=target_cat, reg=target_class, vel=vel,
                         normalize=normalize)
